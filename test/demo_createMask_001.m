...
ipath = 'C:\Users\Administrator\Documents\MATLAB\cut-tobacco-tools\data\001.bmp';
...
largestBlob = bwareafilt(adjustImage, 1);
allExceptLargest = adjustImage & (~largestBlob); % 剔除最大面积
figure
imshow(allExceptLargest)
